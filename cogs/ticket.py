...
from helpers.ticket_system import MyView
...
GUILD_ID = ticket["guild_id"] #Your Server ID aka Guild ID  
...
class Ticket_Command(commands.Cog):
    ...
    async def ticket(self, ctx):
        ...
        embed = discord.Embed(title="🎫 Need help ? 🎫", description="If you have a problem, a question, a proposal or anything else, come and tell us about it in a ticket.", color=discord.colour.Color.blue())
